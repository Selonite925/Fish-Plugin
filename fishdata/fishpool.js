...
export const commonFish = [
  { name: '鲫鱼', size: { min: 10, max: 30 }, weight: { min: 0.05, max: 0.8 } },
  { name: '鲤鱼', size: { min: 20, max: 80 }, weight: { min: 0.5, max: 8 } },
  { name: '草鱼', size: { min: 40, max: 120 }, weight: { min: 2, max: 25 } },
  { name: '鲢鱼', size: { min: 40, max: 100 }, weight: { min: 1.5, max: 20 } },
  { name: '鳙鱼', size: { min: 50, max: 120 }, weight: { min: 3, max: 30 } },
  { name: '白条', size: { min: 8, max: 20 }, weight: { min: 0.02, max: 0.15 } },
  { name: '麦穗鱼', size: { min: 4, max: 12 }, weight: { min: 0.01, max: 0.05 } },
  { name: '泥鳅', size: { min: 8, max: 25 }, weight: { min: 0.02, max: 0.2 } },
  { name: '黄颡鱼', size: { min: 12, max: 35 }, weight: { min: 0.08, max: 0.8 } },
  { name: '罗非鱼', size: { min: 15, max: 45 }, weight: { min: 0.2, max: 3 } },
  { name: '鲮鱼', size: { min: 20, max: 60 }, weight: { min: 0.3, max: 4 } },
  { name: '鲴鱼', size: { min: 15, max: 35 }, weight: { min: 0.1, max: 1 } },
  { name: '鲂鱼', size: { min: 20, max: 45 }, weight: { min: 0.4, max: 2.5 } },
  { name: '鳊鱼', size: { min: 20, max: 50 }, weight: { min: 0.4, max: 3 } },
  { name: '小黄鱼', size: { min: 15, max: 35 }, weight: { min: 0.1, max: 0.8 } },
  { name: '带鱼', size: { min: 50, max: 120 }, weight: { min: 0.3, max: 3 } },
  { name: '鲅鱼', size: { min: 30, max: 100 }, weight: { min: 0.8, max: 10 } },
  { name: '秋刀鱼', size: { min: 20, max: 35 }, weight: { min: 0.08, max: 0.25 } },
  { name: '沙丁鱼', size: { min: 10, max: 25 }, weight: { min: 0.03, max: 0.2 } },
  { name: '鲱鱼', size: { min: 18, max: 35 }, weight: { min: 0.1, max: 0.7 } },
  { name: '凤尾鱼', size: { min: 8, max: 18 }, weight: { min: 0.01, max: 0.08 } },
  { name: '鲻鱼', size: { min: 25, max: 70 }, weight: { min: 0.4, max: 4 } },
  { name: '鲐鱼', size: { min: 25, max: 50 }, weight: { min: 0.3, max: 1.5 } },
  { name: '河鲈', size: { min: 15, max: 50 }, weight: { min: 0.1, max: 2 } },
  { name: '蓝鳃太阳鱼', size: { min: 8, max: 25 }, weight: { min: 0.03, max: 0.6 } },
  { name: '白鲦', size: { min: 7, max: 18 }, weight: { min: 0.01, max: 0.1 } },
  { name: '棘鳅', size: { min: 10, max: 30 }, weight: { min: 0.03, max: 0.3 } },
  { name: '银鲴', size: { min: 15, max: 40 }, weight: { min: 0.15, max: 1.5 } }
];

export const uncommonFish = [
  { name: '鲈鱼', size: { min: 25, max: 70 }, weight: { min: 0.5, max: 6 } },
  { name: '鳜鱼', size: { min: 25, max: 70 }, weight: { min: 0.5, max: 8 } },
  { name: '青鱼', size: { min: 60, max: 160 }, weight: { min: 5, max: 70 } },
  { name: '鲶鱼', size: { min: 40, max: 150 }, weight: { min: 1, max: 40 } },
  { name: '黑鱼', size: { min: 30, max: 100 }, weight: { min: 0.5, max: 10 } },
  { name: '翘嘴', size: { min: 35, max: 100 }, weight: { min: 0.8, max: 15 } },
  { name: '大黄鱼', size: { min: 30, max: 80 }, weight: { min: 0.8, max: 8 } },
  { name: '鲳鱼', size: { min: 20, max: 60 }, weight: { min: 0.3, max: 4 } },
  { name: '海鲈鱼', size: { min: 40, max: 100 }, weight: { min: 1, max: 12 } },
  { name: '鲷鱼', size: { min: 25, max: 80 }, weight: { min: 0.5, max: 8 } },
  { name: '比目鱼', size: { min: 30, max: 100 }, weight: { min: 0.8, max: 10 } },
  { name: '鲽鱼', size: { min: 25, max: 70 }, weight: { min: 0.4, max: 5 } },
  { name: '鳕鱼', size: { min: 40, max: 120 }, weight: { min: 1, max: 20 } },
  { name: '狗鱼', size: { min: 40, max: 120 }, weight: { min: 1, max: 18 } },
  { name: '梭鱼', size: { min: 35, max: 100 }, weight: { min: 0.8, max: 10 } },
  { name: '军曹鱼', size: { min: 60, max: 150 }, weight: { min: 3, max: 35 } },
  { name: '红鼓鱼', size: { min: 40, max: 120 }, weight: { min: 1, max: 25 } },
...
export const rareFish = [
  ...
  { name: '锦鲤', size: { min: 30, max: 100 }, weight: { min: 1, max: 15 } },
  { name: '中华鲟', size: { min: 100, max: 300 }, weight: { min: 30, max: 300 } },
  { name: '虹鳟', size: { min: 30, max: 80 }, weight: { min: 0.5, max: 8 } },
  { name: '鳗鱼', size: { min: 40, max: 120 }, weight: { min: 0.5, max: 8 } },
  { name: '石斑鱼', size: { min: 40, max: 150 }, weight: { min: 2, max: 60 } },
  { name: '金枪鱼', size: { min: 80, max: 250 }, weight: { min: 15, max: 200 } },
  { name: '鲣鱼', size: { min: 40, max: 110 }, weight: { min: 2, max: 25 } },
  { name: '马鲛鱼', size: { min: 50, max: 150 }, weight: { min: 2, max: 40 } },
...
export const epicFish = [
  { name: '帝王鲑', size: { min: 80, max: 150 }, weight: { min: 10, max: 60 } },
  ...
  { name: '大白鲨', size: { min: 300, max: 650 }, weight: { min: 500, max: 2200 } },
