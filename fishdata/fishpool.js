...
export const commonFish = [
  ...
  { name: '晒网银鱼', size: { min: 6, max: 16 }, weight: { min: 0.01, max: 0.08 }, seasonal: { eventId: 'summer_tide_2026', startDate: '2026-07-20', endDateExclusive: '2026-08-10' } },
  { name: '绿茵鳞鱼', size: { min: 8, max: 22 }, weight: { min: 0.02, max: 0.16 }, seasonal: { eventId: 'world_cup_2026', startDate: '2026-07-03', endDateExclusive: '2026-07-20' } },
  { name: '鹊桥银鱼', size: { min: 5, max: 18 }, weight: { min: 0.01, max: 0.1 }, seasonal: { eventId: 'qixi_2026', startDate: '2026-08-10', endDateExclusive: '2026-09-01' } },
...
export const uncommonFish = [
  ...
  { name: '海风青鳞', size: { min: 22, max: 58 }, weight: { min: 0.2, max: 3.5 }, seasonal: { eventId: 'summer_tide_2026', startDate: '2026-07-20', endDateExclusive: '2026-08-10' } },
  { name: '冠军潮鲈', size: { min: 28, max: 72 }, weight: { min: 0.4, max: 5.5 }, seasonal: { eventId: 'world_cup_2026', startDate: '2026-07-03', endDateExclusive: '2026-07-20' } },
  { name: '星河织鳞', size: { min: 24, max: 62 }, weight: { min: 0.3, max: 4.2 }, seasonal: { eventId: 'qixi_2026', startDate: '2026-08-10', endDateExclusive: '2026-09-01' } },
...
export const epicFish = [
  ...
  { name: '织女月鲟', size: { min: 120, max: 280 }, weight: { min: 18, max: 150 }, seasonal: { eventId: 'qixi_2026', startDate: '2026-08-10', endDateExclusive: '2026-09-01' } },
...
export const mysteryFish = [
  ...
  { name: '闲鱼', size: { min: 38, max: 88 }, weight: { min: 0.6, max: 6.8 } },
  {
    ...
    seasonal: { eventId: 'duanwu_2026', startDate: '2026-06-18', endDateExclusive: '2026-07-03' },
...
export const trashItems = [
  ...
  '断掉的浮漂', '泡烂的纸箱', '缠成团的鱼线', '漏水的拖鞋', '生锈的小铁桶',
  '被啃过的玉米罐头', '褪色的广告牌碎片', '泡发的快递袋'
];
...
export const randomEvents = [
  ...
  '一阵海浪打湿了你的衣服！',
  '一只海鸥在你头上拉了一坨！',
  '浮漂明明动了，提竿时却像钩住了一团会消失的影子。',
  '水下像有东西轻轻顶了一下鱼钩，等你反应过来已经没了动静。',
  '刚准备提竿，旁边一阵喧闹把鱼口惊散了。',
  '鱼线绷紧了一瞬，又像被什么悄悄松开。',
  '这一口来得很像样，可惜刺鱼时偏偏慢了半拍。',
  '水面翻了个小花，你和那条鱼谁都没有再多给彼此一次机会。'
];
...
export const lostItemEvents = [
  ...
  { itemName: '耳机', message: '耳机线一滑，你的耳机扑通一声掉进了水里！' },
  { itemName: '保温杯', message: '你刚拧开保温杯盖，它就骨碌骨碌滚进了水里！' },
  { itemName: '折叠凳', message: '折叠凳脚下一歪，连带着凳子一头扎进了水里！' },
  { itemName: '饵料盒', message: '手一抖，饵料盒直接翻进了水里！' },
  { itemName: '抄网', message: '抄网没放稳，顺着岸边滑进了水里！' }
];
