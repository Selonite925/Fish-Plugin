...
// 深海生命值不足时，鱼不会进入鱼缸，而是沿着各自的潮痕逃回裂谷。
// 普通稀有度使用分档演出；传说和彩蛋鱼按鱼名保留独立逃脱文本。
const DEEP_SEA_ESCAPE_PERFORMANCES = Object.freeze({
  common: Object.freeze([
    { intro: '鱼线只轻轻一沉，深海冷压却已经逼近船舷。', reveal: '你勉强扬竿，细小鱼影在最后一刻松钩，带着一点荧光沉回黑暗。' },
    { intro: '探照灯扫过一片碎光，鱼口的动静忽然变得遥远。', reveal: '那条鱼贴着缆绳滑走，只留下几枚气泡，钩尖最终空空荡荡。' }
  ]),
  uncommon: Object.freeze([
    { intro: '鱼线传来一阵急促的颤动，船底的水压警报跟着亮起。', reveal: '鱼影挣开了钩口，绕过船尾的暗流后消失在一片蓝黑色水纹里。' },
    { intro: '一束冷光沿着鱼线向上爬，竿梢被压得几乎贴近甲板。', reveal: '你刚要收线，鱼影便借着回流脱身，只在黑潮里留下一道短暂的鳞光。' }
  ]),
  rare: Object.freeze([
    { intro: '水下传来沉重的撞击，鱼线像被整条海沟拽向更深处。', reveal: '生存警报抢先一步响彻船舱，鱼影趁着你收力的瞬间切断水纹，逃回裂谷。' },
    { intro: '探照灯照出一双逼近的眼睛，船身在暗流里向后滑去。', reveal: '你没有足够余力完成最后一轮牵引，那道鱼影翻身钻入岩缝，钩上只剩冷水。' }
  ]),
  epic: Object.freeze([
    { intro: '海沟像突然合拢，巨大的拉力把鱼线拖出一串刺耳的回响。', reveal: '你咬牙提竿仍没能稳住它，巨影撞开一面潮墙，带着震动沉入无光处。' },
    { intro: '鱼线绷成一道发亮的弧，船灯被巨物的影子完全遮住。', reveal: '生存线已经无法承受这次牵引，鱼影甩尾脱钩，整片海面只剩散开的荧光。' }
  ]),
  legendary: Object.freeze({
    generic: Object.freeze([
      { intro: '传说鱼影已经越过船舷，海沟深处却同时升起刺耳的生存警报。', reveal: '你无力完成收线，巨影带着整片潮汐松开鱼线，重新沉回传说诞生的黑暗。' }
    ]),
    byFish: Object.freeze({
      '深海灯塔鲸': { intro: '深海灯塔鲸已经点亮背脊上的航灯，船舱却先一步亮起生存警报。', reveal: '你无力守住这条引航光带，灯鲸拖着满背灯火断线下沉，裂谷重新暗了下来。' },
      '裂谷古龙': { intro: '裂谷古龙沿着逆流升起，龙吟震得岩层一层层回应。', reveal: '生存线撑不住这次逆流牵引，古龙咬断潮线，带着发光地层回到裂谷底部。' },
      '逆流利维坦': { intro: '逆流利维坦已经把海面倒转，船只被拖向看不见底的深处。', reveal: '你只能松开最后一段力道，利维坦携着倒流海水穿过鱼线，重新隐入反向潮汐。' },
      '星环巨乌贼': { intro: '星环巨乌贼托着一圈圈星环升起，触手缠住了整片月光。', reveal: '你的生存线先于鱼线崩紧，巨乌贼收回触手，连同星环一起沉回海底夜空。' },
      '黑潮海皇': { intro: '黑潮海皇从分开的海面中抬起王冠般的影子，潮钟声震得甲板发颤。', reveal: '你无法承受海皇的潮令，只能看着它收回王冠与黑潮，消失在更深的王座之后。' },
      '海沟天柱鲸': { intro: '海沟天柱鲸从垂直黑暗里拔地而起，背脊像一座移动的山脉。', reveal: '生存线无法撑住这座山脉的牵引，天柱鲸翻入深处，留下逐渐熄灭的声呐刻度。' },
      '深蓝星龙': { intro: '深蓝星龙吐出冷色龙息，整条裂谷被照成一片倒悬星河。', reveal: '你松手避开骤降的水压，星龙收起龙息，沿着星河退回无人能追的深处。' },
      '永夜巨鲨': { intro: '永夜巨鲨绕船一周，海面星光一盏盏熄灭，鱼线像被夜色咬住。', reveal: '生存警报压过了最后一声提竿，巨鲨张口吞回鱼线，带着永夜重新合上裂谷。' },
      '潮汐母舰': { intro: '潮汐母舰拖着整片回流驶过船底，远方潮水像舰队列阵。', reveal: '你无法承受母舰的潮令，鱼线被回流整齐收走，庞大舰影驶回无灯海域。' },
      '沉星古鲸': { intro: '一颗暗淡星光坠入海面，沉星古鲸在悠长鲸歌里托起整片夜空。', reveal: '生存线在鲸歌里逐渐失去力道，古鲸带着坠星沉回海沟，浪花也随之安静。' }
    })
  }),
  [EASTER_EGG_RARITY]: Object.freeze({
    generic: Object.freeze([
      { intro: '彩蛋鱼影把深海变成一面梦境，船上的生存警报却将你拉回现实。', reveal: '你无法完成最后一次提竿，鱼影从现实的缝隙里滑走，只留下一点无法收藏的微光。' }
    ]),
    byFish: Object.freeze({
      '潜梦水母鱼': { intro: '潜梦水母鱼把水面折成一面梦镜，透明触须已经缠住你的鱼线。', reveal: '生存线先一步断开梦境，潜梦水母鱼带着未醒的星光穿回镜后，收藏里没有留下它。' },
      '无声鳐': { intro: '无声鳐掠过船底，所有声呐同时归零，连你的呼吸都像被海水按住。', reveal: '你无力完成无声的牵引，鳐鱼剪断最后一帧浪花，安静地消失在裂谷深处。' },
      '零点灯鱼': { intro: '深海钟声停在零点，零点灯鱼叼着一粒微光靠近钩尖。', reveal: '生存警报惊散了这枚坐标，灯鱼带着零点退回黑暗，海图上没有亮起新的收藏。' }
    })
  })
});
...
// 默认与每日钓鱼次数刷新保持一致；实际触发时间由 dailyResetHour 配置决定。
export const DEEP_SEA_NIGHT_RETURN_HOUR = 0;

const DEEP_SEA_DAMAGE_PROFILES = Object.freeze({
  common: Object.freeze({ chance: 0.08, min: 3, max: 7 }),
  uncommon: Object.freeze({ chance: 0.14, min: 4, max: 10 }),
  rare: Object.freeze({ chance: 0.23, min: 6, max: 15 }),
  epic: Object.freeze({ chance: 0.34, min: 10, max: 22 }),
  legendary: Object.freeze({ chance: 0.52, min: 18, max: 36 }),
  [EASTER_EGG_RARITY]: Object.freeze({ chance: 0.62, min: 24, max: 48 })
});
...
export function getDeepSeaEscapePerformance(fish = {}, options = {}) {
  const rarity = String(fish?.rarity || 'common');
  const configured = DEEP_SEA_ESCAPE_PERFORMANCES[rarity] || DEEP_SEA_ESCAPE_PERFORMANCES.common;
  const random = typeof options.random === 'function' ? options.random : Math.random;
  const specific = configured.byFish?.[fish?.name];
  if (specific) {
    return {
      rarity,
      fishName: String(fish?.name || ''),
      specific: true,
      intro: specific.intro,
      reveal: specific.reveal
    };
  }
  const pool = Array.isArray(configured) ? configured : configured.generic;
  const randomIndex = pool?.length
    ? Math.min(pool.length - 1, Math.max(0, Math.floor(Number(random()) * pool.length)))
    : 0;
  const fallback = pool?.length ? pool[randomIndex] : DEEP_SEA_ESCAPE_PERFORMANCES.common[0];
  return {
    rarity,
    fishName: String(fish?.name || ''),
    specific: false,
...
export function ensureMapState(userData = {}) {
  ...
  userData.mapState.lastGroupId = String(userData.mapState.lastGroupId || '').trim();
  userData.mapState.lastDisplayName = String(userData.mapState.lastDisplayName || '').trim();
  userData.mapState.lastReturnAt = Math.max(0, Number(userData.mapState.lastReturnAt || 0));
