...
export const MAX_TANK_LEVEL = 10;
export const MAX_TANK_CAPACITY = DEFAULT_TANK_CAPACITY + MAX_TANK_LEVEL * TANK_UPGRADE_SIZE;
...
export const EASTER_EGG_EFFECTS = {
  ...
  '端午𩽾𩾌': {
    aliases: ['端午', '端午鱼', '端午彩蛋', '端午彩蛋鱼', '端午鮟鱇', '端午鮟鱇鱼', '端午鮟鱇魚', '粽叶鱼', '五色线鱼'],
    baitPreserveChance: 0.16,
    failProtection: 0.04,
    description: '粽叶水纹会护住鱼饵，也会把几次落空的竿稍轻轻托回来'
  },
  '潜梦水母鱼': {
    sourceMap: '深海裂谷',
    deepSeaDamageReduction: 0.24,
    deepSeaHealthCostReduction: 3,
    description: '梦光会替你分担深海冲击，危险鱼影和每次下潜的压力都不再那么容易撞上船舷'
  },
  '无声鳐': {
    sourceMap: '深海裂谷',
    deepSeaDamageReduction: 0.14,
    deepSeaFishballRateBonus: 0.04,
    deepSeaHealthRecovery: 4,
    description: '它带来的无声潮流会缓和暗流，顺利起鱼后还会替生存线补回一小段余力'
  },
  '零点灯鱼': {
    sourceMap: '深海裂谷',
    deepSeaFishballRateBonus: 0.07,
    deepSeaHealthCostBonus: 3,
    description: '零点灯光照亮回航刻度，承受更深的下潜压力来换取更多鱼丸回响'
  }
};
...
const LEGENDARY_ROD_BLUEPRINTS = [
  ...
  {
    id: 'legend_lighthouse_whale',
    sourceLegendary: '深海灯塔鲸',
    name: '灯鲸引航竿',
    waitMultiplier: 1.04,
    catchRateBonus: 0.018,
    failProtection: 0.22,
    signalBonusCoins: 18,
    deepSeaHealthCostReduction: 2,
    deepSeaFishballRateBonus: 0.01,
    rarityBias: { common: -0.03, uncommon: -0.015, rare: 0.018, epic: 0.012, legendary: 0.008 },
    description: '乳白竿身里封着一线灯火，导环像鲸背上的航标，随着潮声一明一暗。'
  },
  {
    id: 'legend_rift_ancient_dragon',
    sourceLegendary: '裂谷古龙',
    name: '裂谷龙脊竿',
    waitMultiplier: 0.96,
    catchRateBonus: 0.024,
    failProtection: 0.2,
    deepSeaHealthRecovery: 4,
    rarityBias: { common: -0.04, uncommon: -0.02, rare: 0.02, epic: 0.015, legendary: 0.012 },
    description: '竿脊由一节节暗金骨纹连成，握住时像有古老的潮汐在掌心缓慢转身。'
  },
  {
    id: 'legend_reverse_leviathan',
    sourceLegendary: '逆流利维坦',
    name: '逆潮禁航竿',
    waitMultiplier: 1.18,
    catchRateBonus: -0.04,
    failProtection: 0.42,
    catchCoinBonus: 22,
    deepSeaHealthCostBonus: 4,
    deepSeaFishballRateBonus: 0.06,
    rarityBias: { common: -0.05, uncommon: -0.02, rare: 0.02, epic: 0.026, legendary: 0.019 },
    description: '黑银竿身刻着倒流的潮线，竿梢永远朝着与海水相反的方向。'
  },
  {
    id: 'legend_ring_squid',
    sourceLegendary: '星环巨乌贼',
    name: '星环引力竿',
    waitMultiplier: 1.06,
    catchRateBonus: 0.008,
    failProtection: 0.26,
    signalBonusCoins: 28,
    deepSeaHealthCostReduction: 1,
    deepSeaFishballRateBonus: 0.03,
    rarityBias: { common: -0.035, uncommon: -0.018, rare: 0.022, epic: 0.018, legendary: 0.014 },
    description: '竿身绕着一圈圈紫蓝光环，线轮转动时，附近的水声会向它轻轻靠拢。'
  },
  {
    id: 'legend_black_tide_emperor',
    sourceLegendary: '黑潮海皇',
    name: '黑潮镇海竿',
    waitMultiplier: 1.08,
    ...
    deepSeaFishballRateBonus: 0.03,
    rarityBias: { common: -0.04, uncommon: -0.02, rare: 0.022, epic: 0.02, legendary: 0.016 },
    description: '竿节压着一枚沉黑海冕，竿尾像锚一样稳，能把翻涌的潮头钉在原处。'
  },
  {
    id: 'legend_pillar_whale',
    sourceLegendary: '海沟天柱鲸',
    name: '天柱沉锚竿',
    waitMultiplier: 1.2,
    catchRateBonus: -0.05,
    failProtection: 0.44,
    catchCoinBonus: 28,
    deepSeaHealthCostBonus: 5,
    deepSeaFishballRateBonus: 0.08,
    rarityBias: { common: -0.05, uncommon: -0.02, rare: 0.02, epic: 0.028, legendary: 0.02 },
    description: '竿身厚重如一截海底山脊，握柄上的鲸纹会在巨物咬钩时逐节亮起。'
  },
  {
    id: 'legend_blue_star_dragon',
    sourceLegendary: '深蓝星龙',
    name: '星蓝龙息竿',
    waitMultiplier: 0.86,
    catchRateBonus: 0.055,
    failProtection: 0.12,
    baitPreserveChance: 0.22,
    deepSeaHealthRecovery: 3,
    deepSeaFishballRateBonus: 0.02,
    rarityBias: { common: 0.01, uncommon: 0.008, rare: 0.014, epic: 0.012, legendary: 0.008 },
    description: '深蓝竿身浮着细碎星点，竿梢吐出一缕冷光，像龙息在海面下缓慢游走。'
  },
  {
    id: 'legend_eternal_night_shark',
    sourceLegendary: '永夜巨鲨',
    name: '永夜猎潮竿',
    waitMultiplier: 1.1,
    catchRateBonus: -0.03,
    failProtection: 0.36,
    ...
    rarityBias: { common: -0.045, uncommon: -0.02, rare: 0.02, epic: 0.024, legendary: 0.018 },
    description: '竿身像没有尽头的夜色，银白护片排列成鲨齿，越是安静的海面越能听见它。'
  },
  {
    id: 'legend_tidal_carrier',
    sourceLegendary: '潮汐母舰',
    name: '母舰统潮竿',
    waitMultiplier: 1,
    ...
    signalBonusCoins: 44,
    deepSeaHealthCostReduction: 2,
    deepSeaHealthRecovery: 2,
    deepSeaFishballRateBonus: 0.04,
    rarityBias: { common: -0.035, uncommon: -0.018, rare: 0.022, epic: 0.02, legendary: 0.016 },
    description: '竿身像一艘缩小的黑潮舰，线轮展开时会带起整齐的潮纹，仿佛有水手在甲板下应答。'
  },
  {
    id: 'legend_fallen_star_whale',
    sourceLegendary: '沉星古鲸',
    name: '沉星回声竿',
    waitMultiplier: 1.12,
    catchRateBonus: -0.018,
    failProtection: 0.34,
    ...
    deepSeaHealthRecovery: 3,
    deepSeaFishballRateBonus: 0.03,
    rarityBias: { common: -0.04, uncommon: -0.018, rare: 0.02, epic: 0.024, legendary: 0.018 },
    description: '竿节里嵌着暗淡星砂，提竿时会先传来一声远鲸回响，再把力道交到手中。'
  }
];
...
export const LOTTERY_ROD_PLUGINS = {
  gold_humble: {
    ...
    catchRateBonus: -0.012,
    failProtection: 0.1,
    externalModifierMultiplier: 0.5,
    rarityBias: {
      common: 0.018,
      uncommon: 0.006,
      rare: -0.008,
    ...
    description: '竿身鎏金却薄得像一线晨光，握把缠着素白细绳；借来的潮势会被金线悄悄压低。'
  },
  tide_observer: {
    id: 'lottery_tide_observer',
    sourceLottery: true,
    lotteryValue: 2800,
    recycleValue: 1400,
    name: '潮汐观测竿',
    aliases: ['潮汐观测竿', '观测竿', '潮汐竿', '记录竿'],
    price: 0,
    waitMultiplier: 1,
    catchRateBonus: 0.006,
    failProtection: 0.08,
    baitPreserveChance: 0.16,
    seasonalSurvey: {
      missingFishSelectionChance: 0.55,
      sizeMultiplier: 1.08,
      weightMultiplier: 1.1
    },
    description: '竿身刻着潮线和月相刻度，观测环会在赛季鱼影掠过时校正读数，专为补全限定图鉴与记录而造。'
  }
};
...
export const LOTTERY_GRAND_PRIZE_PLUGINS = {
  ...
  tide_observer_rod: {
    id: 'tide_observer_rod',
    name: '潮汐观测竿',
    aliases: ['潮汐观测竿', '观测竿', '潮汐竿', '记录竿'],
    description: '一把追踪当前赛季未收集鱼的限定鱼竿；不提高稀有度和鱼讯收益，只会在同稀有度内尝试锁定遗漏鱼影，并强化该次记录体型。',
    reward: {
      type: 'rod',
      id: LOTTERY_ROD_PLUGINS.tide_observer.id,
      value: 2800,
      duplicateCompensationCoins: 1400
    }
  }
};
...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    ...
    { type: 'bait', id: 'festival_zongzi_bait', packCount: 1, weight: 0.05, value: 120, title: '粽子 1包', desc: '端午限定：1包3份，库存 +3 份', seasonal: { eventId: 'duanwu_2026', startDate: '2026-06-18', endDateExclusive: '2026-07-03' } }
  ]
};

export const DUANWU_EVENT_CONFIG = {
  id: 'duanwu_2026',
  baitId: 'festival_zongzi_bait',
  startDate: '2026-06-18',
  endDateExclusive: '2026-07-03',
  dailyGiftPackCount: 1,
  failEventChance: 0.1,
  rewardCoins: { min: 200, max: 700 },
  easterEggGift: {
    fishName: '端午𩽾𩾌',
    chance: 0.25
  }
...
export const BAIT_CATALOG = {
  ...
  festival_zongzi_bait: {
    id: 'festival_zongzi_bait',
    name: '粽子',
    aliases: ['粽子', '端午粽子', '粽子鱼饵', '端午鱼饵', '节令粽子'],
    price: 120,
    packSize: 3,
    seasonal: {
      eventId: 'duanwu_2026',
    ...
    randomEffects: [
      {
        name: '艾草清香',
        desc: '艾草香气压住了水底的杂味，上鱼率小幅上升。',
        catchRateBonus: 0.08
      },
      {
        name: '蜜枣甜口',
        desc: '甜香把稍深处的鱼影也勾得近了一点。',
        rarityBias: { common: -0.025, uncommon: -0.01, rare: 0.018, epic: 0.012, legendary: 0.004 }
      },
      {
        name: '糯米扎实',
        desc: '饵团沉得稳，咬口里的个头更有分量。',
        sizeMultiplier: 1.08,
        weightMultiplier: 1.08,
        minWeightRatio: 0.18
      },
      {
        name: '彩绳稳结',
        desc: '彩绳绕得结实，偶尔能把饵稳稳留在钩上。',
        baitPreserveChance: 0.12
      },
      {
        name: '龙舟鼓点',
        desc: '鼓点顺着水面推开，传说和彩蛋鱼影更容易被惊动。',
        rarityBias: { common: -0.02, uncommon: -0.012, rare: 0.006, epic: 0.01, legendary: 0.01, [EASTER_EGG_RARITY]: 0.006 }
      }
    ],
    catchRateBonus: 0,
    rarityBias: {},
    description: '青绿箬叶裹着糯米香，棉线扎成小角，落水时还带一点节令甜气。'
  }
};
...
export const SHOP_ITEMS = {
  ...
  festival_zongzi_bait: {
    ...BAIT_CATALOG.festival_zongzi_bait,
    type: 'bait'
  },
  extra_ticket: {
    id: 'extra_ticket',
...
export const ACHIEVEMENT_DEFS = [
  ...
  },
  {
    id: 'common_master',
    name: '常见鱼学家',
    description: '集齐全部常驻 common 鱼种（赛季鱼不计）。',
    rewardCoins: 160,
    rewards: {
      tickets: 1
    }
  },
  {
    id: 'uncommon_master',
    name: '水色辨识家',
    description: '集齐全部常驻 uncommon 鱼种（赛季鱼不计）。',
    rewardCoins: 260,
    rewards: {
      tickets: 1,
  ...
  },
  {
    id: 'rare_master',
    name: '深水名录',
    description: '集齐全部常驻 rare 鱼种（赛季鱼不计）。',
    rewardCoins: 420,
    rewards: {
      tickets: 2,
  ...
  },
  {
    ...
    name: '传说考据者',
    description: '累计见过 10 种不同的常驻 legendary 鱼。',
    rewardCoins: 500,
    rewards: {
      tickets: 3,
      baits: [{ id: 'deep_bait', count: 2 }]
    }
  },
  {
  ...
  {
    id: 'encyclopedia_veteran',
    name: '百水见闻',
    description: '集齐 80 种不同的常驻鱼。',
    rewardCoins: 360,
    rewards: {
      tickets: 2,
      baits: [{ id: 'special_bait', count: 3 }]
    }
  },
  {
    id: 'encyclopedia_complete',
    name: '沧海全录',
    description: '集齐图鉴中的全部常驻鱼种。',
    rewardCoins: 1200,
    rewards: {
      tickets: 5,
      baits: [{ id: 'dragon_bait', count: 3 }]
    }
  },
  {
    id: 'thirty_catches',
  ...
  {
    id: 'three_hundred_catches',
    name: '熟练钓手',
    description: '累计钓到 300 条鱼。',
    rewardCoins: 300,
    rewards: {
      tickets: 2,
  ...
  },
  {
    id: 'market_veteran',
    name: '鱼市老字号',
    description: '在鱼市完成 50 次交易。',
    rewardCoins: 350,
    rewards: {
      tickets: 2,
      baits: [{ id: 'amber_bait', count: 3 }]
    }
  },
  {
    id: 'rod_collector',
  ...
  {
    id: 'lottery_grand_prize',
    name: '愿海回响',
    description: '第一次获得钓鱼祈愿大奖。',
    rewardCoins: 300,
    rewards: {
      tickets: 2,
      baits: [{ id: 'special_bait', count: 2 }]
  ...
  {
    id: 'lottery_grand_collector',
    name: '双愿同辉',
    description: '累计收藏 2 件不同的钓鱼祈愿大奖。',
    rewardCoins: 700,
    rewards: {
      tickets: 4,
      baits: [{ id: 'dragon_bait', count: 2 }]
