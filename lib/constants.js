...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    { type: 'coins', min: 18, max: 26, weight: 0.08, value: 22, title: '零散鱼币', desc: '袋底还有几枚亮晶晶的鱼币' },
    ...
    { type: 'lottery_free_draw', count: 1, weight: 0.11, value: 70, title: '再祈一愿', desc: '获得 1 次免费钓鱼祈愿' },
    { type: 'lottery_free_draw', count: 10, weight: 0.011, value: 700, title: '免费十连', desc: '获得 10 次免费钓鱼祈愿' },
    { type: 'bait', id: 'special_bait', count: 2, weight: 0.055, value: 30, title: '香谷鱼饵 x2', desc: '稳定好用的垫池鱼饵' },
    { type: 'bait', id: 'deep_bait', count: 1, weight: 0.032, value: 27, title: '沉流鱼饵 x1', desc: '给深水口留一点机会' },
    { type: 'bait', id: 'lottery_gilt_bait', count: 1, weight: 0.07, value: 58, title: '鎏金团饵 x1', desc: '愿品限定：金粉在饵面浮成细碎涟漪' },
    { type: 'bait', id: 'lottery_humble_bait', count: 1, weight: 0.07, value: 46, title: '谦光素饵 x1', desc: '愿品限定：白得近乎透明，只在边缘留一圈淡金' },
    { type: 'bait', id: 'lottery_starry_bait', count: 1, weight: 0.055, value: 62, title: '星屑诱饵 x1', desc: '愿品限定：深蓝饵粉里嵌着细小星点' },
    { type: 'bait', id: 'lottery_abyss_bait', count: 1, weight: 0.045, value: 74, title: '渊金鱼饵 x1', desc: '愿品限定：黑金色饵团沉甸甸地泛着深水光' },
    { type: 'bait', id: 'lottery_giant_bait', count: 1, weight: 0.055, value: 68, title: '王鳞重饵 x1', desc: '愿品限定：饵面压着大块鳞纹，像一枚小金属坠' },
    { type: 'bait', id: 'lottery_mirror_bait', count: 1, weight: 0.035, value: 40, title: '镜水留饵 x1', desc: '愿品限定：湿润得像一片能照出倒影的水面' }
  ]
};
...
export const BAIT_CATALOG = {
  ...
  lottery_humble_bait: {
    ...
    description: '白得近乎透明，边缘只有一圈很淡的金线，安静得像没打算赢。'
  },
  lottery_starry_bait: {
