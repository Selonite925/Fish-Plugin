...
export const RARITY_WEIGHT_PRICE = {
  common: 1,
  uncommon: 1.4,
  rare: 2.1,
  epic: 3.2,
...
// 3. catchRateBonus 现在允许做到 +0.15，但越强就越应该配更高价格或更低包数。
...
export const BAIT_CATALOG = {
  ...
  special_bait: {
    ...
    packSize: 3,
    catchRateBonus: 0.07,
    rarityBias: { common: 0.02, uncommon: 0.01, rare: -0.005 },
