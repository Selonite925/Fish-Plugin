...
export const TANK_UPGRADE_COSTS = {
  legendary: { rarity: 'legendary', count: 1 },
  epic: { rarity: 'epic', count: 3 }
};
...
export const BAIT_CATALOG = {
  ...
  special_bait: {
    ...
    packSize: 3,
    catchRateBonus: 0.12,
    rarityBias: { common: 0.018, uncommon: 0.012, rare: -0.004 },
