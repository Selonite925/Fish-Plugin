...
export const EASTER_EGG_EFFECTS = {
  ...
  '闲鱼': {
    ...
    description: '自己钓起垃圾、捞起失物，或把少量失手翻成垃圾时，会被它顺手回收成鱼币'
  }
};
...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    { type: 'coins', min: 18, max: 26, weight: 0.0844, value: 22, title: '零散鱼币', desc: '袋底还有几枚亮晶晶的鱼币' },
    { type: 'coins', min: 42, max: 58, weight: 0.12, value: 50, title: '小袋鱼币', desc: '回收台下摸出一小袋鱼币' },
    { type: 'coins', min: 76, max: 98, weight: 0.12, value: 87, title: '沉甸鱼币', desc: '袋子不大，但响得很踏实' },
    { type: 'coins', amount: 180, weight: 0.043, value: 180, title: '闪金鱼币', desc: '一枚挺会发光的金色前菜' },
    ...
    { type: 'lottery_free_draw', count: 1, weight: 0.01, value: 100, title: '再祈一愿', desc: '获得 1 次免费钓鱼祈愿，面值 100 鱼币' },
    { type: 'lottery_free_draw', count: 10, weight: 0.0006, value: 1000, title: '免费十连', desc: '获得 10 次免费钓鱼祈愿，面值 1000 鱼币' },
    ...
    { type: 'bait', id: 'lottery_dark_tide_bait', packCount: 1, weight: 0.025, value: 60, title: '冥潮逆饵 1包', desc: '愿品限定：1包1份，库存 +1 份' },
