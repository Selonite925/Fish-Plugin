...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    ...
    { type: 'coins', min: 76, max: 98, weight: 0.135, value: 87, title: '沉甸鱼币', desc: '袋子不大，但响得很踏实' },
    { type: 'coins', amount: 180, weight: 0.045, value: 180, title: '闪金鱼币', desc: '一枚挺会发光的金色前菜' },
    { type: 'ticket', count: 1, weight: 0.13, value: 58, title: '额外钓鱼券', desc: '今日上限后可再多抛一竿' },
