...
// 因此稀有鱼基准期望为 1500 * 2% = 30 灵石/次成功上鱼；可售鱼区间按 30 / 当前稀有度概率反推后取整。
...
export const EASTER_EGG_EFFECTS = {
  ...
  '闲鱼': {
    ...
    description: '自己钓起垃圾、捞起失物，或把少量失手翻成垃圾时，会被它顺手回收成灵石'
  }
};
...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    { type: 'coins', min: 18, max: 26, weight: 0.0844, value: 22, title: '零散灵石', desc: '袋底还有几枚亮晶晶的灵石' },
    { type: 'coins', min: 42, max: 58, weight: 0.139, value: 50, title: '小袋灵石', desc: '回收台下摸出一小袋灵石' },
    { type: 'coins', min: 76, max: 98, weight: 0.12, value: 87, title: '沉甸灵石', desc: '袋子不大，但响得很踏实' },
    { type: 'coins', amount: 180, weight: 0.043, value: 180, title: '闪金灵石', desc: '一枚挺会发光的金色前菜' },
