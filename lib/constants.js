...
export const EASTER_EGG_EFFECTS = {
  ...
  '闲鱼': {
    ...
    description: '自己钓起垃圾或捞起失物时，会被它顺手回收成鱼币'
  }
};
...
export const LOTTERY_ROD_PLUGINS = {
  gold_humble: {
    ...
    targetFishEffect: {
      ...
      distractorPoolSizeRules: {
        min: 1,
        max: 4,
        thresholds: [
          { minPoolSize: 50, count: 4 },
          { minPoolSize: 35, count: 3 },
          { minPoolSize: 24, count: 2 }
        ]
      },
      rarityBiasByTargetRarity: {
        common: { rare: 0.14, epic: 0.17, legendary: 0.033, [EASTER_EGG_RARITY]: 0.016 },
        uncommon: { rare: 0.135, epic: 0.165, legendary: 0.032, [EASTER_EGG_RARITY]: 0.016 },
        rare: { rare: 0.13, epic: 0.162, legendary: 0.03, [EASTER_EGG_RARITY]: 0.015 },
        epic: { epic: 0.154, legendary: 0.028, [EASTER_EGG_RARITY]: 0.014 },
        legendary: { epic: 0.14, legendary: 0.026, [EASTER_EGG_RARITY]: 0.013 },
        [EASTER_EGG_RARITY]: { epic: 0.138, legendary: 0.013, [EASTER_EGG_RARITY]: 0.026 }
      },
      rewardCoinsByRarity: {
        common: 2300,
        uncommon: 2700,
...
export const LOTTERY_CONFIG = {
  ...
  regularRewards: [
    { type: 'coins', min: 18, max: 26, weight: 0.154, value: 22, title: '零散鱼币', desc: '袋底还有几枚亮晶晶的鱼币' },
    { type: 'coins', min: 42, max: 58, weight: 0.09, value: 50, title: '小袋鱼币', desc: '回收台下摸出一小袋鱼币' },
    { type: 'coins', min: 76, max: 98, weight: 0.09, value: 87, title: '沉甸鱼币', desc: '袋子不大，但响得很踏实' },
    { type: 'coins', amount: 180, weight: 0.025, value: 180, title: '闪金鱼币', desc: '一枚挺会发光的金色前菜' },
    { type: 'ticket', count: 1, weight: 0.11, value: 58, title: '额外钓鱼券', desc: '今日上限后可再多抛一竿' },
    { type: 'ticket', count: 2, weight: 0.035, value: 116, title: '双尾钓鱼券', desc: '两次额外抛竿，适合继续追口' },
    { type: 'lottery_free_draw', count: 1, weight: 0.11, value: 100, title: '再祈一愿', desc: '获得 1 次免费钓鱼祈愿，面值 100 鱼币' },
    { type: 'lottery_free_draw', count: 10, weight: 0.011, value: 1000, title: '免费十连', desc: '获得 10 次免费钓鱼祈愿，面值 1000 鱼币' },
    { type: 'bait', id: 'special_bait', count: 2, weight: 0.055, value: 30, title: '香谷鱼饵 2份', desc: '鱼饵库存 +2 份，稳定好用的垫池鱼饵' },
    { type: 'bait', id: 'deep_bait', count: 1, weight: 0.032, value: 27, title: '沉流鱼饵 1份', desc: '鱼饵库存 +1 份，给深水口留一点机会' },
    { type: 'bait', id: 'lottery_gilt_bait', packCount: 1, weight: 0.06, value: 58, title: '鎏金团饵 1包', desc: '愿品限定：1包1份，库存 +1 份' },
    { type: 'bait', id: 'lottery_humble_bait', packCount: 1, weight: 0.03, value: 92, title: '谦光素饵 1包', desc: '愿品限定：1包2份，库存 +2 份' },
    { type: 'bait', id: 'lottery_starry_bait', packCount: 1, weight: 0.048, value: 62, title: '星屑诱饵 1包', desc: '愿品限定：1包1份，库存 +1 份' },
    { type: 'bait', id: 'lottery_abyss_bait', packCount: 1, weight: 0.045, value: 74, title: '渊金鱼饵 1包', desc: '愿品限定：1包1份，库存 +1 份' },
    { type: 'bait', id: 'lottery_giant_bait', packCount: 1, weight: 0.048, value: 68, title: '王鳞重饵 1包', desc: '愿品限定：1包1份，库存 +1 份' },
    { type: 'bait', id: 'lottery_mirror_bait', packCount: 1, weight: 0.015, value: 80, title: '镜水留饵 1包', desc: '愿品限定：1包2份，库存 +2 份' }
  ]
};
